    ...
    return (
            <div className="container pt-5">
                <div className="row pt-4">
                    <div data-aos='zoom-in-up' className=" col-12 col-md-6 text-end pt-3 ">
                    ...
                    <div data-aos='zoom-out' className="col-12 col-md-6  features-intro-img">
                        <div className='about-image'><img className='w-100' src={obgImg} alt="img" /></div>
                    </div>
                </div>
                <div className="row mt-5 pt-4">
                    <div data-aos='zoom-in' className="col-12 col-md-6  features-intro-img">
                        <div className='about-image'><img className='w-100' src={obgImg2} alt="img" /></div>
                    </div>
                    <div data-aos='zoom-out-right' className="col-12 col-md-6 text-end pt-3 ">
